     ...
     2    RPROPS     ,UNSYM      )
      ...
      LOGICAL UNSYM
      PARAMETER( IPHARD=5  ,NLALGV=2  ,NRSTAV=5 )
      DIMENSION
     1    IPROPS(*)          ,RPROPS(*)
      DATA R0   /0.0D0/
C***********************************************************************
C READ AND ECHO MATERIAL PROPERTIES FOR VON MISES TYPE ELASTO-PLASTIC
C MATERIAL WITH NON-LINEAR DIFFERENCED THRESHOLD (PIECEWISE LINEAR)
C ISOTROPIC HARDENING (TRACTION-COMPRESION)
C
C REFERENCE: Linero D. L. (2010)
C***********************************************************************
 1000 FORMAT('Elasto-plastic with VON MISES (T-C) yield criterion'/)
 1100 FORMAT(
     1' Mass density ...................................... =',G15.6/
     2' Young''s modulus ................................... =',G15.6/
     3' Poisson''s ratio ................................... =',G15.6/
     4' Threshold difference factor (C/T)................... =',G15.6)
 1200 FORMAT(/
...
C Read and echo some of the real properties
      ...
      READ(15,*)YOUNG,POISS
      READ(15,*)FACTCT
      WRITE(16,1100)DENSE,YOUNG,POISS,FACTCT
      IF(YOUNG.LE.R0)CALL ERRPRT('ED0100')
      IF(FACTCT.LE.R0)CALL ERRPRT('ED0101') !CAMBIAR TIPO DE ERROR
